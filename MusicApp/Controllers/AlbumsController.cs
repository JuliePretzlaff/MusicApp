...
namespace MusicApp.Controllers
{
    public class AlbumsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AlbumID,ArtistID,ReleaseYear,WonAward,AlbumPhoto,BestHit")] Album album)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AlbumID,ArtistID,ReleaseYear,WonAward,AlbumPhoto,BestHit")] Album album)
        {
            if (ModelState.IsValid)
            {
